...
var Anew = exports.Anew = function () {
    ...
    _createClass(Anew, [{
        ...
        value: function use(pkg, config) {
            if (config) {
                this.packages.push({ package: pkg, config: config });
            } else {
        ...
        key: 'render',
        value: function render(entry, query) {
            if (typeof entry === 'string' && !query) {
                query = entry;
                entry = undefined;
            }

            var AnewApp = (0, _composePackages2.default)(this.packages, !!query)(entry);

            if (query) {
                (0, _reactDom.render)(_react2.default.createElement(AnewApp, null), (0, _getElement2.default)(query));
            }
